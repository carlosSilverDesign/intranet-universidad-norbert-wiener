...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /**
   * RECALCULAR ESTADÍSTICAS POR FILA DE ALUMNO
  ...
  /**
   * DESKTOP DRAG-TO-SCROLL (DESPLAZAMIENTO HORIZONTAL CON CLIC SOSTENIDO)
  ...
  /**
   * INTERACTIVIDAD DE MARCACIÓN EN CASILLAS
   * Clic:
  ...
  /**
   * BOTÓN "REGISTRAR ASISTENCIA ALUMNO"
   */
  ...
  /**
   * ESTILO DINÁMICO PARA ANIMACIÓN DE CARGA DEL BOTÓN
   */
